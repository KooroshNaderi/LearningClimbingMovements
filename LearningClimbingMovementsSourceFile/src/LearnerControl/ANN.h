...
public:
	...
	void apply_weight_decay(float learning_rate, float weight_decay);
...
public:
	...
	void bayesian_optimization(const float** in, const float** out, unsigned data_points, unsigned minibatch_size);
