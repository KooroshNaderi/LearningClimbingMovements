...
{
	rcCapsule=0,rcSphere,rcBox,rcLine,rcMaterial,rcColor,rcViewPoint,rcPrint,rctScreenShot,rctLightPosition,rctMarkerCircle,rcGround
};
...
void rcDrawGround(const float z);
